...
export function Hero() {
  return (
    <section
      className="relative w-full min-h-[90vh] bg-gradient-to-b from-[#0a1a0f] via-[#0d1f12] to-black overflow-hidden"
      dir="rtl"
    >
      ...
      <div className="container relative z-10 px-4 sm:px-6 md:px-8 flex flex-col items-center pt-16 sm:pt-20 md:pt-24">
        ...
        >
          ...
          <p className="text-white/60 text-sm sm:text-base md:text-lg leading-relaxed">
            حوّل تجربتك إلى بديل خالٍ من التبغ مع دزرت دون دخان، أو رائحة، أو
            قيود.
          </p>
        </motion.div>
